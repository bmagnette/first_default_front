            ...
            <div className="add_apartment_wrapper">
                <div className="description_form_wrapper">
                    <div className="description_form_wrapper_left">
                        ...
                        <FormGroup>
                            <ControlLabel>Travaux déductibles</ControlLabel>
                            <FormControl type="text" name="deductibleWork" value={values.deductibleWork} onChange={this.props.handleChange('deductibleWork')} placeholder="Travaux déductibles"/>
                        </FormGroup>
                    </div>
